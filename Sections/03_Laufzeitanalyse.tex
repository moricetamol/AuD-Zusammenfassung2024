...
Dieser Algorithmus hat eine Laufzeit von $\Omega(1)$, da, wenn $n == 2$ ist, der Algorithmus sofort mit einem Rückgabewert von 0 Schritten abgeschlossen wird. Das bedeutet, dass die minimale Anzahl von Schritten 0 ist, was zu einer Laufzeit von $\Omega(1)$ führt. Ohne das vorzeitige Abbrechen würde der Algorithmus wie geplant $O(n^2)$ und $\Omega(n^2)$ sein, da die Anzahl der Schritte sowohl maximal als auch minimal $n^2$ ist. 
...
Hier können wir $\Theta$ nicht verwenden, da die obere Schranke $O(n^2)$ ist, aber die untere Schranke $\Omega(1)$ ist. 
