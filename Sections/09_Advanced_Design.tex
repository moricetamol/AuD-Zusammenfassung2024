...
\end{algorithm}
\includepdf[pages={16-21}, pagecommand={},nup=2x3, frame=true, scale=0.9]{../VL_Folien/07AdvancedDesigns.pdf}
\includepdf[pages={26-33}, pagecommand={},nup=2x4, frame=true, scale=0.95]{../VL_Folien/07AdvancedDesigns.pdf}
...
\end{algorithm}
\includepdf[pages={60-67}, pagecommand={},nup=2x4, frame=true, scale=0.9]{../VL_Folien/07AdvancedDesigns.pdf}
...
\includepdf[pages={90-94}, pagecommand={},nup=2x3, frame=true, scale=0.9]{../VL_Folien/07AdvancedDesigns.pdf}
\end{document}