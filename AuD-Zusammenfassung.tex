...
Während des durchlaufens nach links werden die Elemente so nach Rechts geschoben, so dass eine Einfügespalte ensteht. Nach dem Ende dieses Durchgangs ist der Wert 
...
\lstinputlisting[language=Java, lastline = 50]{Code/BSTree.java}
\newpage
\lstinputlisting[language=Java, firstline = 52]{Code/BSTree.java}
...
\lstinputlisting[language=Java, lastline = 38]{Code/RBTree.java}
\newpage
\lstinputlisting[language=Java, firstline = 39, lastline = 76]{Code/RBTree.java}
\newpage
\lstinputlisting[language=Java, firstline = 77]{Code/RBTree.java}
