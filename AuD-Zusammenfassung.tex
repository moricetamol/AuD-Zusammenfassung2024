...
\newpage
\subfile{Sections/9 Advanced Design/9 Advanced Design.tex}
\newpage
\subfile{Sections/10 Nichtdeterministische Polynomialzeit/10 Nichtdeterministische Polynomialzeit.tex}
\end{document}